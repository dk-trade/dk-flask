/* results_ui_call_credit_spread.js
 *
 * Renders and sorts the OTM call-credit-spread-strategy results table.
 * Exposes a global ResultsUI class just like the other strategies,
 * so ui_call_credit_spread.js can initialize it with:
 *
...
(() => {
    ...
    const COLS = [
      ...
      { key: "lowerStrike",   label: "Sell Strike" },
      { key: "higherStrike",  label: "Buy Strike" },
      { key: "spreadWidth",   label: "Spread Width" },
      { key: "lowerMid",      label: "Sell Mid" },
      { key: "higherMid",     label: "Buy Mid" },
    ...
    class ResultsUI {
      ...
      render() {
        ...
        summary.textContent = `Showing ${rows.length} profitable OTM call credit spread opportunities.`;
