 ...
 *
 * Renders and sorts the call-spread-strategy results table.
 * Exposes a global ResultsUI class just like the other strategies,
 * so ui_call_spread.js can initialize it with:
 *
...
(() => {
    ...
    class ResultsUI {
      ...
      render() {
        ...
        summary.textContent = `Showing ${rows.length} profitable call spread opportunities.`;
